...
this.aanFeatures=[];this.oLanguage={sProcessing:"正在载入...",sLengthMenu:"显示 _MENU_ 条记录",sZeroRecords:"没有符合的记录",sEmptyTable:"当前还没有数据",sInfo:"当前显示 _START_ 到 _END_ /共 _TOTAL_ 条记录",sInfoEmpty:"当前显示 0 到 0 /总共 0 条记录",sInfoFiltered:"(从 _MAX_ 条记录过滤后)",sInfoPostFix:"",sSearch:"搜索:",sUrl:"",oPaginate:{sFirst:"首页",sPrevious:"&lt;Prev",sNext:"Next>",sLast:"末页"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
